...
const SignInWithGoogle = ({router}) => {
  ...
  return (
      <Button
        ...
        size="large"
        style={{ fontSize: '17px', padding: '22px 20px', border: '1px solid silver', backgroundColor: 'white'}}
        onClick={handleSignIn}
      >
        { loading ? <Spin indicator={<Loading3QuartersOutlined style={{fontSize: '19px'}} spin />} size="small" /> : <>&nbsp;Sign In with Google</> } 
      </Button>
  );
};
